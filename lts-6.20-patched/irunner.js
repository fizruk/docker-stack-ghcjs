...
var h$GHCJSiPort = process.env['GHCJSI_PORT'] || 6401;
...
if (h$GHCJSiStaticDir) {
  try {
    ...
    console.log(e)
    console.log("\n--------------------------------------------------------------------------")
    console.log("Can't set up static file server for " + h$GHCJSiStaticDir);
    console.log("\nMake sure you have filehandler and serve-static installed:");
    console.log("\n    npm install filehandler serve-static");
    console.log("\nIf those packages are installed, check that NODE_PATH is set up properly.");
    console.log("--------------------------------------------------------------------------")
  }
}
